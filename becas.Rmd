...
En el análisis se puedo observar que el modelo de reglas de clasificación obtuvo un menor porcentaje de error en cuanto a los modelos restantes debido a que el AUC obtuvo area de 0.73 considerandose como una exactitud moderada. Cabe destacar que, debido a que se tiene poca data para realizar entrenamiento, los algoritmos no poseen un desempeño óptimo, por lo que en ocasiones el AUC de los modelos podría variar.
