...
-Para generar el modelo basado en reglas de clasificación se utilizó  la función JRip a la cual se le pasó como paramétro una fórmula y la data de entrenamiento  dicha fórmula especifica que, a partir de todos los campos, se va a predecir el atributo mIngreso. 
```
